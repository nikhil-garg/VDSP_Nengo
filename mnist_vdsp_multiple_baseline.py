...
def evaluate_mnist_multiple_baseline(args):
    ...
    image_train_filtered_all = args.input_scale*data['image_train_filtered']/255
    label_train_filtered_all = data['label_train_filtered']
    image_test_filtered = args.input_scale*data['image_test_filtered']/255
    ...
    for i in range(0,input_nbr):
        ...
        image_train_filtered.append(image_train_filtered_all[i])
        label_train_filtered.append(label_train_filtered_all[i])
